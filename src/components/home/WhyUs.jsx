...
const FEATURES = [
  ...
  { icon: "user-check", title: "الملاعب المعتمدة", text: "يتم زيارة كل نادٍ على موقع PadelGo والتحقق منه، لذا فإن الصور تتطابق دائمًا مع المكان الذي تدخل إليه." },
];
    ...
    <section className="news-section section" id="how-it-works">
      <div className="container">
        <div className="text-center mx-auto" style={{ maxWidth: 620 }} data-aos="fade-up">
          <span className="eyebrow justify-content-center">لماذا PadelGo</span>
